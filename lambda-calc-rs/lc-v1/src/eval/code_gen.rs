        ...
        match decl {
            ...
            ADecl::Let(decl) => {
                ...
                match &decl.name_opt {
                    ...
                    Some(..) => {
                        todo!()
                        // let id = self.alloc_local_var(name);
                        // self.map_stack.last_mut().unwrap().insert(name.text, Name::LocalVar(id));
                    }
                    _ => {}
                }
