...
fn test_app_eval_order() {
	assert_eq!(eval("(println (to_str (- (read_int) (read_int))))", "42 3"), "39\n");
}
...
#[test]
fn test_set() {
	assert_eq!(eval(r#"(+ (let a 2) (set a (+ a 3)) (println (to_str a)))"#, ""), "5\n")
}

#[test]
fn test_string_primitives() {
	assert_eq!(eval(r#"(println (to_str 42) " is answer")"#, ""), "42 is answer\n");
